      ...
      <div className="flex space-x-2 mt-8 flex-wrap">
        {dataByArea.map((a) => (
          <button
            ...
            className={
              selectedArea === a.area
                ? "px-4 py-2 rounded-full text-sm font-semibold shadow bg-green-dark text-white"
                : "px-4 py-2 rounded-full text-sm font-semibold shadow bg-gray-200 text-gray-700"
            }
